...
import { FaReact, FaDatabase, FaHtml5, FaCss3Alt, FaBootstrap, FaWindows } from "react-icons/fa";
import { SiMaterialformkdocs, SiDotnet, SiPostman, SiVitest } from "react-icons/si";
...
import ChallengeIMG from '../assets/proyects/Challenge_TDevs.webp'
...
const ProyectosData = [
    ...
    },
    {
        ...
        img: GymTrackerIMG,
        titulo: "GYM Tracker",
        descripcion: "Aplicación que permite el seguimiento y progreso personal del peso. Instrucciones de instalación/depuración dentro del repositorio. ACTUALMENTE SE ENCUENTRA EN WORK IN PROGRESS (WIP)",
        linkRepo: "https://github.com/AguzKind/JuegoDados",
        linkDemo: "",
        tags: [
            { name: "C#", icon: <SiDotnet />, colorClass: "bg-gradient-to-r from-purple-100 to-purple-200 text-purple-900" },
