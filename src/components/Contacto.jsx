...
const Contacto = ({ fondo, texto, fondoBoton, titular }) => {
  Aos.init();
  return (
        ...
        <form action="https://getform.io/f/7c0216c5-dfdf-4e40-9341-a08bd106e8ed" method='POST' encType='multipart/form-data'>
          <div className='grid md:grid-cols-2 gap-4 w-full py-2'>
            <div className='flex flex-col'>
              <label className={`${texto} uppercase text-sm py-2 font-roboto font-semibold`}>Nombre</label>
              <input className="border-2 rounded-lg p-3 flex border-green-500" type="text" name='name' required />
            </div>
            <div className='flex flex-col'>
              <label className={`${texto} uppercase text-sm py-2 font-roboto font-semibold`}>Asunto</label>
          ...
          <div className='flex flex-col py-2'>
            <label className={`${texto} uppercase text-sm py-2 font-roboto font-semibold`}>Tu mensaje: </label>
