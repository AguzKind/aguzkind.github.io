...
const ExperienciaModelo = ({anios, titulo, lugar, detalles, texto, certificados, info}) => {
  return (
    ...
    data-aos="zoom-in">
      <li className='mb-10 ml-5'>
        ...
        <p className='flex flex-wrap gap-4 flex-row items-center justify-start text-xs md:text-sm'> 
          ...
          <b>|</b>
          <a href="#" className={`${certificados} my-1 text-sm font-semibold leading-none pt-0.5 cursor-pointer hover:scale-110 ease-in duration-200`}> Ver Certificado</a>
        </p>
        <p className={`${texto} my-2 text-base font-normal`}>{detalles}</p>
      </li>
    </ol>
  )
}
